...
const META = [
  ...
  { slug:'artivita',          titulo:'Artivita',                         desc:'Suporte natural para articulacoes e mobilidade',                       img:'/img/produtos/artivita/artivita3.png',   preco:'139.90' },
  { slug:'lipojaro',          titulo:'Lipojaro',                         desc:'Suplemento natural',                                                   img:'/img/produtos/lipojaro/lipojaro2.png',   preco:'189.90' },
  { slug:'znorex',            titulo:'Znorex',                           desc:'Protetor bucal anti-ronco',                                            img:'/img/produtos/znorex/znorex1.png',       preco:'149.90' },
    ...
    '@graph': [
      {
        ...
        image:         [imgUrl],
        brand:         { '@type': 'Brand', name: 'Armazem Natural' },
        offers: {
          '@type':       'Offer',
          priceCurrency: 'BRL',
          price:         prod.preco,
          ...
          url,
          seller:        { '@type': 'Organization', name: 'Armazem Natural' },
        },
        aggregateRating: {
